(function()
{
    ...
    {  
            ...
            for(var k in buttons)
            {
                ...
                else if(k == 'image')
                {
                    ...
                    {  
						...
						{
							curThis.pasteAtCurrentPosition(img.outerHTML, image.placeHolder);
						}
						else
						{
                ...
                else if(k == 'smiles')
                {
                    ...
                    aButton.on('click', function(e)
                    {
                        ...
                        if(target.nodeName == 'A')
                        {
							...
							if(smiles.placeHolder !== undefined)
							{
								curThis.pasteAtCurrentPosition(target.outerHTML, smiles.placeHolder);
							}
							else
							{
        ...
        this.pasteAtCurrentPosition = function(html, placeHolder)
        {  
			if(placeHolder !== undefined)
			{
				if(this.textarea.innerHTML == placeHolder)
				{
